...
10. Breitling : Spécialiste des montres d’aviation, précision et robustesse au programme. Ce classement reflète à la fois l’histoire, l’innovation et l’impact culturel de ces marques dans le monde entier. Chaque maison a su créer un univers unique, mêlant tradition et excellence. ','Le Point','https://i.pinimg.com/736x/1f/18/a1/1f18a10cc0617ae6066e8b28701813e2.jpg','https://i.pinimg.com/1200x/27/39/bd/2739bdc6721dd69964bec1c96a7084b2.jpg',3);
...
VALUES (
  ...
  'https://i.pinimg.com/1200x/fb/02/56/fb0256d6293200c6acbb9faa4d9e28a8.jpg',
  3
);
...
INSERT INTO `user` (firstname, lastname, birthdate, user_type, e_mail, user_role, user_describe, created_at, password, user_photo) 
VALUES ('Anaïs','B','1980-01-01','Directrice Éditoriale & Curatrice','anaisberthome@gmail.com','admin', "Historienne de l'art, elle veille à la qualité des articles et au respect de l'héritage des manufactures. Elle déniche les pièces rares.",'2026-01-22 08:30:00', '', 'https://www.trajektoire.be/metiers/images/horloger-horlogere_20250905_133328.png'),
...
('Thomas','P','2000-01-01','Développeur & Webmaster','thomas.p@gmail.com','admin', "Passionné de 'Toolwatches', il assure la fluidité du site, la sécurité des transactions et l'optimisation de l'interface utilisateur.", '2026-01-18 08:30:00', '', 'https://www.agerix.fr/component/ajax/?p=cache/bf/bfb69e10.webp&src=images/stories/blog/2024/comprehension-des-processus-metier-pour-les-developpeurs.jpg&thumbnail=1200,676,&type=webp,85&hash=29653400'),
('Mathieu', 'H', '2000-01-01', 'Analyste Marché & Cote', 'mathieu.h@gmail.com','admin', "Expert en économie, il suit l'évolution des prix et les ventes aux enchères pour conseiller les membres sur l'investissement horloger.", '2026-01-02 08:30:00', '', 'https://institut-superieur-environnement.com/content/uploads/2022/04/metier-analyste-esg-2.jpg'),
...
('Joachim', 'Masson', '', 'Expert Technique & Authentification', 'jo@admin.fr','admin', "Ancien horloger certifié, il est le garant de la véracité technique et aide à identifier les contrefaçons (le 'LC' pour Legit Check).", '2025-09-01 08:30:00', '$2b$10$/frmOJpVIVEXPQWCdjYFmuvtazIuFs43.IvYJNC/RFZWJPXjFhBau', 'https://cdn.prod.website-files.com/63d2e1fb8b7be21d1508d0f9/660d41953448413d2ebd5009_293733D6-970B-4DA6-BA55-9A79C2123B3B.JPG'),
('Aurélie', 'DUMOTIER', '1986-02-14', 'Responsable Communauté & Évenements', 'aurelie@test.com', 'admin', "Spécialiste en communication de luxe, elle gère les membres VIP et organise les rencontres physiques entre passionnés (les 'GTG').", '2026-02-01 08:30:00', '$2b$10$abe.6Swei6O1Rw44IzG.a.HzJZ.oY37bhF5/OfreONKXnnAOWaT.W', 'https://img.freepik.com/photos-gratuite/femme-tenant-reunion-bureau-collegues_23-2148908800.jpg?t=st=1770284448~exp=1770288048~hmac=89224e20518bab7b7a4eee6016f2abf22fbbe0b1d43d0c0f5941b7f4aaf52f84'),
('Romain', 'Debas', '1988-02-02', 'Responsable Image & Partenariats', 'debasromain@gmail.com','admin', "Photographe spécialisé en macro-horlogerie, il gère l'identité visuelle du site et les relations avec les grandes maisons.", '', '$2b$10$3.bsPn7LlURcw2rtM2DUrOZsOWzsIGL86JnNXy21rnyam2q/XrvHK', 'https://img.freepik.com/photos-gratuite/deux-hommes-se-serrent-main-devant-voiture_613910-16936.jpg?t=st=1770284625~exp=1770288225~hmac=621f60eef18d7d1285b48d08da5777107c97a9a70c186d400ccafd15b22bf566'),
