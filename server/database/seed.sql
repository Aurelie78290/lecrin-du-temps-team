...
-- Suppression des verrous pour éviter les blocages
INSERT INTO `user` (firstname, lastname, birthdate, user_type, e_mail, user_role, user_describe, password) 
VALUES 
('Anaïs','B','1980-01-01','Directrice Éditoriale & Curatrice','anaisberthome@gmail.com','admin', "Historienne de l'art...", ''),
('Joachim','Masson','1980-01-01','Expert Technique & Authentification','joachim.masson.17@gmail.com','admin', "Ancien horloger certifié...", ''),
('Aurélie','Dumotier','1986-02-14','Responsable Communauté & Évenements','aurelie.dumotier@gmail.com','admin', "Spécialiste en communication...", ''),
('Thomas','P','2000-01-01','Développeur & Webmaster','thomas.p@gmail.com','admin', "Passionné de 'Toolwatches'...", ''),
('Mathieu', 'H', '2000-01-01', 'Analyste Marché & Cote', 'mathieu.h@gmail.com','admin', "Expert en économie...", ''),
-- Utilisation de NULL pour les dates manquantes au lieu de ''
('romain', 'dodo', NULL, NULL, 'test@test.com', 'user', NULL, '$2b$10$YQWyYMtItnsmh5nINQLJau22ZKqfbfD2oYnxy5pBxjxERGl/.Vjia'),
('Jean', 'Dubois', '1980-01-01', 'cutsomer', 'jean.dubois@gmail.com','customer', "Collectionneur de montre", ''),
('Jo', 'M', NULL, NULL, 'jo@admin.fr','admin', NULL, '$2b$10$/frmOJpVIVEXPQWCdjYFmuvtazIuFs43.IvYJNC/RFZWJPXjFhBau'),
('Aurélie', 'DUMOTIER', NULL, NULL, 'aurelie@test.com', 'admin', NULL, '$2b$10$abe.6Swei6O1Rw44IzG.a.HzJZ.oY37bhF5/OfreONKXnnAOWaT.W'),
('Romain', 'Debas', '1988-02-02', 'Responsable Image & Partenariats', 'debasromain@gmail.com','admin', "Photographe...", '$2b$10$3.bsPn7LlURcw2rtM2DUrOZsOWzsIGL86JnNXy21rnyam2q/XrvHK'),
('User', 'Todelete', NULL, NULL, 'testdelete@test.com', 'user', NULL, '$2b$10$7AR5Ntccmsv1HVJ4x4LB/OYBfZJOEThsVcWdyC2ltPFLHGbS/v3Zm'),
('User', 'Toadmin', NULL, NULL, 'test4@test.com', 'user', NULL, '$2b$10$2SZrItauGHOPUnGBlZq8MOSotSiyGTfzIKU.d5fRYdO8JT3u8BYXK');
